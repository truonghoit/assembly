					...
					>
						<CardBody className="panel__body">
							...
							<div className="panel__btns">
								<button className="panel__btn" type="button" onClick={this.onCollapse}><MinusIcon/>
								</button>
								<button className="panel__btn" type="button" onClick={this.onRefresh}><AutorenewIcon/>
								</button>
								<button className="panel__btn" type="button" onClick={this.onDismiss}><CloseIcon/>
								</button>
							</div>
