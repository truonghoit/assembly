...
class DefectBarChart extends Component {
	constructor(props) {
		super(props);
	}
	...
	drawChartItem = (chartData) => {
		...
		let defectDataArray = [];
		let chartLabels = chartData[2]?chartData[2]:["7:30", "8:30", "9:30", "10:30", "11:30", "12:30", "13:30", "14:30", "15:30", "16:30", "17:30", "18:30", "19:30", "20:30", "21:30", "22:30"];
		let chartTypeArray = chartData[1]?chartData[1]:["HO KEO (BONDING)", "LEM KEO (OVER-CEMENT)", "LEM NUOC XU LY (OVER-PRIMER)", "DO (DIRTY)", "NHAN (WRINKLE)", "LOI KHAC (ETC)"]
		...
		return  <Col style={{backgroundColor: bgColor, marginRight: 10, marginBottom: 10, borderRadius: 5}}>
					<MixedLineBarChart labels={labels} data={datasets} chartOptions={chartOptions} chartInitialData={initialData} labels={chartLabels} type={chartType} showLegend={false} />
				</Col>
	}
