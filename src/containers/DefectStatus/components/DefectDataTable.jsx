...
class DefectDataTable extends Component {
	...
	fillRow = (threeLargestArray, dataItem, rowNo) => {
		...
		if (Object.keys(dataItem).length > 0){
			...
			col[1] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[1]}}>{dataArray[1]}</td>;
			col[2] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[2] }}>{dataArray[2]}</td>;
			col[3] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[3] }}>{dataArray[3]}</td>;
			col[4] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[4] }}>{dataArray[4]}</td>;
			col[5] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[5] }}>{dataArray[5]}</td>;
			col[6] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[6] }}>{dataArray[6]}</td>;
			col[7] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[7] }}>{dataArray[7]}</td>;
			col[8] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[8] }}>{dataArray[8]}</td>;
			col[9] =    <td style={{textAlign:'center', backgroundColor: backgroundColorArray[9] }}>{dataArray[9]}</td>;
			col[10] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[10]}}>{dataArray[10]}</td>;
			col[11] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[11]}}>{dataArray[11]}</td>;
			col[12] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[12]}}>{dataArray[12]}</td>;
			col[13] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[13]}}>{dataArray[13]}</td>;
			col[14] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[14]}}>{dataArray[14]}</td>;
			col[15] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[15]}}>{dataArray[15]}</td>;
			col[16] =   <td style={{textAlign:'center', backgroundColor: backgroundColorArray[16]}}>{dataArray[16]}</td>;
			col[17] =   <td style={{textAlign:'center', backgroundColor: '#082738'}}>{dataArray[17]}</td>
	...
	fillBody = (data) => {
		...
		if (data.length >= 6){
			let qualityArray = [
				[data[0].Qty_0730, data[1].Qty_0730, data[2].Qty_0730, data[3].Qty_0730, data[4].Qty_0730, data[5].Qty_0730],
				[data[0].Qty_0830, data[1].Qty_0830, data[2].Qty_0830, data[3].Qty_0830, data[4].Qty_0830, data[5].Qty_0830],
				[data[0].Qty_0930, data[1].Qty_0930, data[2].Qty_0930, data[3].Qty_0930, data[4].Qty_0930, data[5].Qty_0930],
				[data[0].Qty_1030, data[1].Qty_1030, data[2].Qty_1030, data[3].Qty_1030, data[4].Qty_1030, data[5].Qty_1030],
				[data[0].Qty_1130, data[1].Qty_1130, data[2].Qty_1130, data[3].Qty_1130, data[4].Qty_1130, data[5].Qty_1130],
				[data[0].Qty_1230, data[1].Qty_1230, data[2].Qty_1230, data[3].Qty_1230, data[4].Qty_1230, data[5].Qty_1230],
				[data[0].Qty_1330, data[1].Qty_1330, data[2].Qty_1330, data[3].Qty_1330, data[4].Qty_1330, data[5].Qty_1330],
				[data[0].Qty_1430, data[1].Qty_1430, data[2].Qty_1430, data[3].Qty_1430, data[4].Qty_1430, data[5].Qty_1430],
				[data[0].Qty_1530, data[1].Qty_1530, data[2].Qty_1530, data[3].Qty_1530, data[4].Qty_1530, data[5].Qty_1530],
				[data[0].Qty_1630, data[1].Qty_1630, data[2].Qty_1630, data[3].Qty_1630, data[4].Qty_1630, data[5].Qty_1630],
				[data[0].Qty_1730, data[1].Qty_1730, data[2].Qty_1730, data[3].Qty_1730, data[4].Qty_1730, data[5].Qty_1730],
				[data[0].Qty_1830, data[1].Qty_1830, data[2].Qty_1830, data[3].Qty_1830, data[4].Qty_1830, data[5].Qty_1830],
				[data[0].Qty_1930, data[1].Qty_1930, data[2].Qty_1930, data[3].Qty_1930, data[4].Qty_1930, data[5].Qty_1930],
				[data[0].Qty_2030, data[1].Qty_2030, data[2].Qty_2030, data[3].Qty_2030, data[4].Qty_2030, data[5].Qty_2030],
				[data[0].Qty_2130, data[1].Qty_2130, data[2].Qty_2130, data[3].Qty_2130, data[4].Qty_2130, data[5].Qty_2130],
				[data[0].Qty_2230, data[1].Qty_2230, data[2].Qty_2230, data[3].Qty_2230, data[4].Qty_2230, data[5].Qty_2230]
			];
